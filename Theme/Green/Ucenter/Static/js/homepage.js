...
/*资料弹窗*/
//小搜索框js
$('.fanssearch_box').mouseenter(function(){
$('.fanssearch_box .fans_search').addClass("border-orange");
$('.fanssearch_img').addClass("fanssearch_img2")
})
$('.fanssearch_box').mouseleave(function(){
$('.fanssearch_box .fans_search').removeClass("border-orange");
$('.fanssearch_img').removeClass("fanssearch_img2")
})
$(".data_pop").hide();
$(".more_box2").hide();
...
$(".down_order").mouseenter(function(){
	...
	$(this).find('.order_img').addClass("order_img2");
	$(this).find('.order_img3').addClass("order_img4");
	})
$(".down_order").mouseleave(function(){
	m=$(".down_order").index(this);
	$(".down_order p").eq(m).removeClass("downp_style")
	//$(".order_img").eq(m).removeClass("order_img2")
	$(this).find('.order_img').removeClass("order_img2");
	$(this).find('.order_img3').removeClass("order_img4");
	})
