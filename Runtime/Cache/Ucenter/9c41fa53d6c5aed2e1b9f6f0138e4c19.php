...
<div class="fans_body container">
  <div class="fans_left left ">
        ...
        <div class="my_fans fans_style">
           ...
           <a href=""> <p class=" left cl50"><?php if($userInfo['uid']==is_login()&&is_login()){ echo '我'; }elseif($userInfo['sex']==2){ echo '她';}else{ echo '他';} ?>的粉丝&nbsp;<span style="color:#303030"><?php echo ($userInfo['fans']); ?></span></p>
       </a> </div>
        <div class="clear"></div>
    </div>
   ...
   <div class="fans_right right">
    	<div class="fans_title">
        	<h1 class="left cl50 px14"><?php if(intval(I('get.togtherFollow'))){echo '共同关注&nbsp';}elseif($userInfo['uid']==is_login()&&is_login()){ echo '我的粉丝&nbsp;'; }elseif($userInfo['sex']==2){ echo '她的粉丝&nbsp;';}else{ echo '他的粉丝&nbsp;';} ?><span><?php if(intval(I('get.togtherFollow'))): echo ($togtherFollowTotal); else: echo ($fans['total']); endif; ?></span></h1>
        </div>
        <?php if($isOwner): ?><div class="fans_order cl50">
            ...
            <div class="down_pop">
            	<a href="<?php echo U('Index/fans',array('uid' => $uid));?>"><h1 class="px12 cl50">全部粉丝</h1></a>
                <div class="down_order">
                <?php if($order == 'level'): ?><a href="<?php echo U('Index/fans',array_merge(I('get.'),array('sort'=>'level-'.$by)));?>">
                <?php else: ?>
                <a href="<?php echo U('Index/fans',array_merge(I('get.'),array('sort'=>'level-desc')));?>"><?php endif; ?>
                	<p class="left">按等级</p>
                	<?php if($order == 'level'): ?><div class="order_img<?php if($by=='asc'){echo 3;} ?> right"></div><?php endif; ?>
                    </a>
                </div>
                 <div class="down_order clear">
                 <?php if($order == 'fans'): ?><a href="<?php echo U('Index/fans',array_merge(I('get.'),array('sort'=>'fans-'.$by)));?>">
                 <?php else: ?>
                 <a href="<?php echo U('Index/fans',array_merge(I('get.'),array('sort'=>'fans-desc')));?>"><?php endif; ?>
                	<p class="left">按粉丝</p>
                 ...
                 <?php if($order == 'visit'): ?><a href="<?php echo U('Index/fans',array_merge(I('get.'),array('sort'=>'visit-'.$by)));?>">
                 <?php else: ?>
                 <a href="<?php echo U('Index/fans',array_merge(I('get.'),array('sort'=>'visit-desc')));?>"><?php endif; ?>
                	<p class="left">按访问数</p>
        ...
        <?php if(!empty($fans["fansInfo"])): if(is_array($fans["fansInfo"])): $i = 0; $__LIST__ = $fans["fansInfo"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="fans_section fans_<?php echo ($vo["uid"]); ?>">
            ...
            <div class="fans_data left">
            	<a href="<?php echo U('@'.$vo[username]);?>"><p class="fans_name cl50 ellipsis">微信：<span><?php echo ($vo['nickname']); ?></span></p></a>
                ...
                <a href=""><div class="fans_grade cl50">
                	<p class="left">等级：</p><span class="fans_rank left px12"><i>Lv.<?php echo ($vo["level"]); ?></i></span>
...
//                        }
                    ...
                    function search(){
                    	var url='<?php echo U('Index/fans',I('get.'));?>';
