...
<div class="new_box">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hotman2">
       	<div class="section2">
       	<a href="<?php echo U('/@'.$vo['username']);?>"><img src="<?php echo ($vo["avatar"]); ?>"><p></p></a>
           <a href="<?php echo U('/@'.$vo['username']);?>"><h1>微信：<?php echo ($vo["nickname"]); ?></h1></a>
           <h2><?php echo (date("Y-m-d H:i",$vo["reg_time"])); ?></h2>
           <a href="<?php echo U('Home/Index/tagdetail@', array('catid'=>$vo['catid']));?>"><div class='<?php if($vo[type] == 1): ?>xiangyin2<?php else: ?>xin2<?php endif; ?>'><?php echo ($vo["category"]); ?></div></a>
       </div>
   </div><?php endforeach; endif; else: echo "" ;endif; ?>
   <div class="clear"></div>
   <?php if($page != ''): ?><div class="page_group1 clear ">
	<?php echo ($page); ?>
	</div><?php endif; ?>
	<div class="clear"></div> 
</div>
