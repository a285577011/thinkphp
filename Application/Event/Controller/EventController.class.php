...
class EventController extends AdminController
{
    ...
    public function event($page = 1, $r = 10)
    {
        ...
        $builder->title(L('_CONTENT_MANAGE_'))
            ->setStatusUrl(U('setEventContentStatus'))->buttonDisable('', L('_AUDIT_UNSUCCESS_'))->buttonDelete()->button(L('_RECOMMEND_MAKE_UP_'), array_merge($attr, array('url' => U('doRecommend', array('tip' => 1)))))->button(L('_RECOMMEND_CANCEL_'), array_merge($attr, array('url' => U('doRecommend', array('tip' => 0)))))
