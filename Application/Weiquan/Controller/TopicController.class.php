...
class TopicController extends BaseController
{
    ...
    public function index()
    {
        ...
        if (!$topic) {
            $this->error(L('_TOPIC_NOT_EXIST_PLEASE_CREATE_').L('_EXCLAMATION_'), U('Weiquan/Index/index'));
        }
        ...
        $list = $weiboModel->getWeiquanList($param);
        ...
        $this->assign('total_count', $weiboModel->getWeiquanCount($param['where']));
    ...
    public function beAdmin()
    {
        ...
        if ($topic) {
            if ($topic['uadmin']) {
                ...
                if (is_administrator() || check_auth('Weiquan/Topic/beAdmin')) {
