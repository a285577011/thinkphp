...
class ShareController extends  Controller{
    ...
    public function shareBox(){
        ...
        $this->display(T('Weiquan@default/Widget/share/sharebox'));
    }
    ...
    public function doSendShare(){
        ...
        $info =  D('Weiquan/Share')->getInfo($feed_data);
        $toUid = $info['uid'];
        D('Common/Message')->sendMessage($toUid, L('_PROMPT_SHARE_'),$user['nickname'] . L('_SHARE_CONTENT_SHARED_').L('_EXCLAMATION_'),  'Weiquan/Index/weiboDetail', array('id' => $new_id), is_login(), 1);
