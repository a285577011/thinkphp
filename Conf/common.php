...
return array(
    ...
    'APP_SUB_DOMAIN_RULES'    =>    array(
            '1.i.cn'  => 'Ipai', 
            '*' => array('Weiquan', 'username=*')
    ),
    
    /* 数据缓存设置 */
//     'DATA_CACHE_PREFIX' => 'icn_', //缓存前缀
...
//     'DATA_CACHE_TIME' => 10800,      // 数据缓存有效期 0表示永久缓存
	...
	/* 系统数据加密设置 */
	'DATA_AUTH_KEY' => '97YHkWmIzMP2gcUuOaTCD5pRjw6qyn3LNQEAFGhs', //默认数据加密KEY
...
// 	'DB_CHARSET'=> 'utf8mb4',
	...
	'PICTURE_UPLOAD' => array(
        ...
        'PICTURE_UPLOAD_DRIVER'=>'fastdfs',
	'DOWNLOAD_UPLOAD_DRIVER'=>'fastdfs',	
//	'PICTURE_UPLOAD_DRIVER'=>'local',
//	'DOWNLOAD_UPLOAD_DRIVER'=>'local',
	'REMOTE_FILE_SERVER' => 'http://icnimg.cn/',
    //本地上传文件驱动配置
	...
	'PAYMENT' => array(
	        'alipay' => array(
	                // 收款账号邮箱
	                'email' => 'icniws@163.com',
	                // 加密key，开通支付宝账户后给予
	                'key' => '5fu0js6uuoloyu2fkflltu1zkk577184',
	                // 合作者ID，支付宝有该配置，开通易宝账户后给予
	                'partner' => '2088121830362992'
	        ),
	        'aliwappay' => array(
	                // 收款账号邮箱
	                'email' => 'icniws@163.com',
